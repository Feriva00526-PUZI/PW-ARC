...
window.addEventListener("load", function () {
    ...
    fetch("./../../components/header.html")
        ...
        .then(data => {
            ...
            s_header.style.backgroundImage = "url(./../../media/images/layout/imgLayout15.jpg)";
            s_header.style.backgroundPosition = "50% 70%";

            /*Cambiar el titulo del header */
            document.getElementById("n_h2").innerText = "Estadisticas de los Viajes";
    ...
    fetch("./../../components/footer.html")
        ...
        .then(data => {
            ...
            f_general.style.backgroundImage = "url(./../../media/images/layout/imgLayout16.jpg)";
