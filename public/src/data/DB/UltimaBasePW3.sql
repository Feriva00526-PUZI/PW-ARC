CREATE DATABASE  IF NOT EXISTS `arcpw3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `arcpw3`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: arcpw3
-- ------------------------------------------------------
...
-- Dump completed on 2025-12-01 10:21:55

DROP USER IF EXISTS 'GeneralARCPW3'@'%';

CREATE USER 'GeneralARCPW3'@'%' IDENTIFIED BY 'ARCPW3General';

GRANT DELETE, EXECUTE, INSERT, SELECT, SHOW VIEW, UPDATE ON arcpw3.* TO 'GeneralARCPW3'@'%';
